...
void Analogmeter::plot(void)
{
    // Meter outline
    tft.fillRect(0, 0, M_SIZE*239, M_SIZE*126, TFT_FRAME);
    tft.fillRect(5, 3, M_SIZE*230, M_SIZE*119, TFT_BACKGROUND);
...
{
    tft.setTextColor(TFT_BLACK, TFT_BACKGROUND);
    tft.setTextSize(1);
    ...
    while (!(value == old_analog)) 
    {
        ...
        tft.drawLine(M_SIZE*(120 + 20 * ltx - 1), M_SIZE*(140 - 20), osx - 1, osy, TFT_BACKGROUND);
        tft.drawLine(M_SIZE*(120 + 20 * ltx), M_SIZE*(140 - 20), osx, osy, TFT_BACKGROUND);
        tft.drawLine(M_SIZE*(120 + 20 * ltx + 1), M_SIZE*(140 - 20), osx + 1, osy, TFT_BACKGROUND);
